...
class lastRSS {
	...
	function Parse ($rss_url) {
		...
		if ($rss_content = $http->get($rss_url)) {
			...
			foreach($rss_items as $rss_item) {
                ...
                if($this->check_utf8(utf8_decode($rss_item))) $rss_item = $rss_item;
                else if($this->check_utf8($rss_item)) $rss_item = utf8_decode($rss_item);
    ...
    //Encoding-Check ob Datei UTF-8 oder ISO-8859-1
