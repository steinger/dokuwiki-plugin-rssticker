...
//Relative URL syntax:
var lastrssbridgeurl="lib/plugins/rssticker/bridge.php"

//Absolute URL syntax. Uncomment below line if you wish to use an absolute reference:
//var lastrssbridgeurl="http://"+window.location.hostname+"/rssticker/bridge.php"
...
var parameters="rss_url="+encodeURIComponent(this.RSS_url)+"&cachetime="+this.cachetime+"&bustcache="+new Date().getTime()
